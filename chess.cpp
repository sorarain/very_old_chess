...
int alphaBetaSearch(int (&board)[CHESS_HEIGHT][CHESS_LENGTH], int depth, int alpha, int beta)
{
    ...
    else if(depth % 2 == 0)
    {
        ...
        for(int i = 0;i < MAX_CHOICE;i++)
        {
            ...
            int score = alphaBetaSearch(board, depth - 1,alpha,beta);
...
//                 for(int d = 0;d < 8;d++)
//                 {
//                     if(judgePoints(i + dir[d][0],j + dir[d][1]) 
//                     && board[i + dir[d][0]][j + dir[d][1]] == 0)
//                     {
//                         placepiece[i + dir[d][0]][j + dir[d][1]] = true;
//                     }
//                 }
//             }
//         }
...
//                 score += chess_6_type[board[i][j]][board[i + dir[k][0]][j + dir[k][1]]][board[i + dir[k][0] * 2][j + dir[k][1] * 2]]
//                 [board[i + dir[k][0] * 3][j + dir[k][1] * 3]][board[i + dir[k][0] * 4][j + dir[k][1] * 4]][board[i + dir[k][0] * 5][j + dir[k][1] * 5]];
//                 if(score - pre == WIN)
//                 {
//                     status = 1;
//                 }
